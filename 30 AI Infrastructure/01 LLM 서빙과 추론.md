...
허브: [[30 AI Infrastructure]] · 함께: [[02 쿠버네티스 GPU 오케스트레이션]](서빙을 K8s에 올림)·[[03 MLOps 파이프라인과 관측성]](서빙 메트릭→관측성) · 토대(Infra): [[02 메모리 관리]](KV cache·PagedAttention=메모리 풀)·[[06 컨테이너 내부 구조]](GPU 디바이스 주입)
