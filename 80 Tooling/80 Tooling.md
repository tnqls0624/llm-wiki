...
- **[[00 LLM Wiki 아키텍처와 OKF 자기진단]]** — 구글 OKF v0.1 대비 10차원 자기진단. 표준 계보(OKF·Karpathy LLM Wiki·llms.txt·AGENTS.md·GraphRAG), strong/adequate/gap 판정표, 채택 결정과 의도적 non-goal(임베딩·RDF 배제). 구조 변경·radar review의 기준점.
