...
Agent SDK의 고급 주제(스트리밍, 구조화 출력, 시스템 프롬프트 커스터마이징, 관측성·비용 추적, 호스팅·보안 배포)와 TypeScript/Python API 레퍼런스를 다룬다. SDK의 기초 설치·인증·첫 쿼리는 [[22 Agent SDK — 시작]], 권한·세션·커스텀 도구·서브에이전트·MCP·훅 같은 핵심 기능은 [[23 Agent SDK — 핵심 기능]]을 참조. 허브: [[80 Tooling]].
