...
## 준비할 이미지
1. `1. mnist-examples.png` — MNIST 손글씨 숫자 샘플 (web: Wikimedia 공식 그림 — 수집됨)
2. `2. batch-loss-terminal.png` — batch 64 vs 256 학습 loss 터미널 출력 (shot: 직접 실행 화면 캡처)
...
<!-- IMG: 1 | mnist-examples | web | MNIST 손글씨 숫자 샘플 그리드 | https://upload.wikimedia.org/wikipedia/commons/2/27/MnistExamples.png | Wikimedia Commons (Josef Steppan), CC BY-SA 4.0 -->
<!-- IMG: 2 | batch-loss-terminal | shot | batch 64 vs 256 실행 시 epoch별 loss 터미널 출력 캡처 -->
