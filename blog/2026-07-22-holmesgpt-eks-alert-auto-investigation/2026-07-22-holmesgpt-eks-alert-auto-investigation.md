...
<!-- IMG: 1 | holmesgpt-pipeline-architecture | shot | alert 발생→Alertmanager→robusta-runner→HolmesGPT→Slack 한국어 보고 전체 파이프라인 다이어그램 (mermaid 또는 draw.io로 직접 작성) -->
<!-- IMG: 2 | slack-korean-investigation | shot | 실제 Slack의 한국어 AI 조사 보고 캡처 (4섹션 + 스레드 증거 첨부, 채널명·리소스명 등 민감정보 마스킹) -->
